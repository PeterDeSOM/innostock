...
class PolicyGradient:
    def __init__(self, env, discount_rate=0.99, model_filename=None, history_filename=None):
        self.env = env
...
if __name__ == "__main__":
    ...
    pg = PolicyGradient(env, discount_rate=0.9, model_filename=modelFilename, history_filename=historyFilename)
    pg.train(verbose=1)
