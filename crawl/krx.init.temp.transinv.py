...
querystring = 'SELECT inv_code, inv_name FROM krx_investors WHERE inv_code = %s'
values = ['7050']
df_investors = mariadb.select(querystring, values)
...
datetoday = datetime.strptime('2015-05-26', '%Y-%m-%d')
daysbefore = (datetoday - datetime(2001, 4, 18)).days
